<?php get_header(); ?>
    <div class="content">
	    ...
	    <?php
	    $query = new WP_Query(array('post_type'=>'project', 'taxonomy'=>'project_category', 'term' => 'featured', 'posts_per_page' => 2, 'order' => 'desc'));
		    ...
		    <div class="row">
	            ...
	            <div class="media-body">
			    	<h3 class="list-item-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
			     	...
			     	<a href="<?php the_permalink(); ?>" class="button primary">Case Study</a>
			    </div>
		    </div>
		</div>
